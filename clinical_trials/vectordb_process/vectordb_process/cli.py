...
from vectordb_process.clinicaltrailengine import ClinicalTrailVectorDbEngine
...
@click.option('--qdrant_collection_name', type=str, default="clinical_trials_vector_db", help='provide Qdrant CT Collection Address')
...
def transform_database_to_vectors(
    ...
    ctve.database_to_vectors(database_engine=database_engine)
