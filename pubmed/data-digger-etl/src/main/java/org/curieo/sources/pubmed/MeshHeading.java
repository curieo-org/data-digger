...
public class MeshHeading {
  ...
  @Singular List<Heading> qualifierNames;

  @Override
  public String toString() {
    return String.format(
        "Descriptor %s, Qualifiers %s.",
        descriptorName.toString(),
        qualifierNames.stream().map(Object::toString).collect(Collectors.joining(", ")));
  }

  /**
   * Parse this <MeshHeadingList> <MeshHeading> <DescriptorName UI="D001419"
   * MajorTopicYN="N">Bacteria</DescriptorName> <QualifierName UI="Q000235"
   * MajorTopicYN="N">genetics</QualifierName> <QualifierName UI="Q000302"
   * MajorTopicYN="N">isolation &amp; purification</QualifierName> <QualifierName UI="Q000378"
   * MajorTopicYN="N">metabolism</QualifierName> </MeshHeading>
   */
