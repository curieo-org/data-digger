...
public class ListUtils {
  ...
  /**
   * Compute Cartesian product of multiple lists. Suppose you have three lists of ["a", "b"], ["1",
   * "2", "3"] and ["*", "#"], you will receive 12 lists containing: ["a", "1", "*"], ["a", "1",
   * "#"], ["a", "2", "*"], ["a", "2", "#"], ... ["b", "3", "#"] In other words, all possible
   * combinations.
   *
   * @param <T>
   * @param combination
