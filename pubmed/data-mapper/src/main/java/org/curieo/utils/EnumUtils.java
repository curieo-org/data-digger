...
public class EnumUtils {
  ...
  /**
   * Finds enum value matching name. Works like valueOf() except case-insensitive. Note: If there
   * are enum values that have the same name when not considering casing it will return the first.
   *
   * @param enumClass
   * @param name
   * @return
