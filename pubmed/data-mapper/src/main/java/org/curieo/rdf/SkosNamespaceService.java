...
public class SkosNamespaceService {	
	...
	public static final String EGVS   = "http://www.elsevier.com/xml/schema/rdf/ElsevierGenericVocabularySatellite-1/";
	...
	public static final String ISOTHES = "http://purl.org/iso25964/skos-thes#"; //, which occurred 515 times.
	...
	public static final String KNOV   = "https://data.elsevier.com/engineering/knovel/properties/schema/";
	...
	public static final String[] SKOS_STANDARD_LABELTYPES = new String[] {
			ALTLABEL,
			PREFLABEL,
			HIDDENLABEL
	};
	...
	/**
	 * Get a namespace service. This is a _modifiable_ object so each time
	 * a copy is asked for, create a new one.
	...
	/**
	 * Create a term.
	 * Do not that adding this term *while* you're reading the RDF is probably not going to work
	 * Iterating over the store while writing to it violates some sanity checks
	 * 
	 * @param rdf
	 * @param conceptUri
	 * @param labelUri
	 ...
	 */
	public static Literal createTerm(Store rdf, String conceptUri, String labelUri, String labelText, boolean prefLabel) {
		return createTerm(rdf, conceptUri, labelUri, labelText, "en", prefLabel);
	}

	public static Literal createTerm(Store rdf, String conceptUri, String labelUri, String labelText, String languageId, boolean prefLabel) {
