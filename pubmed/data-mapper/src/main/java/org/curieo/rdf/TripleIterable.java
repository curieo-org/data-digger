...
/**
 * This interface brings the RdfStore more in sync with the API of
 * rdf4j. [Rdf4j is slower but has a nice API]
 * Should we ever choose to swap out one for the other, this makes it easier.
