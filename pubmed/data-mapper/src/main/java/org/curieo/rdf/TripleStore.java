...
/**
 * Interface defining the functionality to stuff triples into some store. Retrieval methods not
 * defined here
 *
 * @author doornenbalm
 */
public interface TripleStore {
  ...
  /**
   * Assert a triple. If an unnamed version of the triple already exists, _name_ it. If a named
   * version of the triple already exists, with another name, let them co-exist
   *
   * @param uri
   * @param subject
   * @param verb
